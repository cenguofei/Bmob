...
data class User(
    ...
    var backgroundUrl: String = "",  //背景url
    var age: Int = 0,    //年龄
    ...
    val identification: Int = USER_HAS_NOT_IDENTIFICATION, //身份
     ...
     */
    val studentClass: String = "", //学生所属班级
     ...
     * true已选，false未选
     */
    var studentSelectState: Boolean = STUDENT_NOT_SELECT_THESIS,
    var isAgree: Boolean = false,

    //2) 老师
    val teacherDetail: String = "", //老师的描述，查看课题详情的时候显示，这个是系统自动为老师生成的资料
) : BmobUser(), Parcelable
